...
define(['ojs/ojcore', 'knockout', 'jquery','promise', 'ojs/ojcheckboxset','ojs/ojswitch',
 ...
 function(oj, ko, $) {
    ...
    function HymnViewModel() {
      var self = this;
      this._id       = ko.observable() ;
      this.name      = ko.observable() ;
      this.author    = ko.observable() ;
      this.songsheet = ko.observable() ;
      ...
      self.obsArray   = ko.observableArray(ArrayHymn) ;
    ...
    self.saveAction = function(formData, event) {
        ...
        if (self.name()) {
           ...
           jsnobj['author'] = self.author() ;
           jsnobj['songsheet'] = self.songsheet() ;
           jsnobj['song'] = self.song() ;
           jsnobj['pattern']   = self.pattern() ;
